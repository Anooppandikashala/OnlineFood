...
<html>
    ...
    <body>
        ...
        <form action="add_food_admin.jsp" method="post">
            <center>
            <table border="1" cellpadding="5" cellspacing="2">
                ...
                <tbody>
                    <tr>
                        <td>Food Name</td>
                        <td><input type="text" name="mname" placeholder="Food Name..." required/></td>
                    </tr>
                    <tr>
                        <td>Price</td>
        ...
        if (request.getParameter("submit") != null) {
           try{ 
                ...
                PreparedStatement pst = conn.prepareStatement("insert into foods (food_name,price,count) values(?,?,?)");
